<div class="col-md-12">
	<div class="row justify-content-between">
		<div class="col-md-auto" style="margin-bottom: 25px;">
			<h5 style="font-size: 1.25rem;">SỬA CHUYÊN NGÀNH</h5>
			<hr>
		</div>
...
<div class="col-md-12">
	...
	{{ form('admin/specializeForm/create', 'method': 'post', 'class':'valid-form', 'novalidate':'') }}
	{% else %}
	{{ form('admin/specializeForm/update', 'method': 'post', 'class':'valid-form', 'novalidate':'') }}
	{% endif %}
		<?=
		...
		<div class='row form-group'>
			<div class="col-md-2 offset-md-3"><label class="control-label">Lĩnh vực:</label></div>
			<div class="col-md-4">
				<?= $form->render('fields_id',['class'=>'form-control']) ?>
			</div>
		</div>
		<div class='row form-group'>
			<div class="col-md-2 offset-md-3"><label class="control-label">Chuyên ngành:</label></div>
			<div class="col-md-4">
