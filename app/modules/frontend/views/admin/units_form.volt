<div class="col-md-12">
	<div class="row justify-content-between">
		<div class="col-md-auto" style="margin-bottom: 25px;">
			<h5 style="font-size: 1.25rem;">SỬA ĐƠN VỊ</h5>
			<hr>
		</div>
...
<div class="col-md-12">
	...
	{{ form('admin/unitsForm/create', 'method': 'post', 'class':'valid-form', 'novalidate':'') }}
	{% else %}
	{{ form('admin/unitsForm/update', 'method': 'post', 'class':'valid-form', 'novalidate':'') }}
	{% endif %}
		<?=
		...
		<div class='row form-group'>
			<div class="col-md-2 offset-md-3"><label class="control-label">Tên đơn vị:</label></div>
			<div class="col-md-4">
				<?= $form->render('name',['class'=>'form-control', 'required'=>true]) ?>
				<div class="invalid-feedback">Tên đơn vị là bắt buộc</div>
			</div>
		</div>
		<div class='row form-group'>
