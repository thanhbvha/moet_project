<div class="col-md-12">
	<div class="row justify-content-between">
		...
		<div class="col-md-auto text-right">
			<a href="<?= $this->url->get('topic') ?>" class="btn btn-outline-secondary btn-sm">
...
<div class="col-md-12">
	<?= $this->tag->form(['topic/form', 'method' => 'post', 'class' => 'valid-form', 'novalidate' => '']) ?>
		<?=
		...
		<div class='row form-group'>
			<div class="col-md-2 offset-md-2">
				<?= $this->tag->submitButton(['Gửi dữ liệu', 'class' => 'btn btn-success']) ?>
			</div>
		</div>
	<?= $this->tag->endForm() ?>
</div>